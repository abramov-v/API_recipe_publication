    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Введите юзернейм', max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Username must be Alphanumeric', regex='^[\\w.@+-]+\\Z')], verbose_name='Имя пользователя')),
